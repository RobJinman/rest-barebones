...
import com.recursiveloop.integrationtest.mocks.MailerProducer;

import com.recursiveloop.resources.RcPendingAccount;
  ...
  public static WebArchive createDeployment() {
    return ShrinkWrap.create(WebArchive.class, "RcPendingAccountTest.war")
      ...
      .addAsWebInfResource(new StringAsset(
        ...
        "    <alternatives>" +
        "      <class>com.recursiveloop.integrationtest.mocks.MailerProducer</class>" +
        "    </alternatives>" +
        "</beans>"), "beans.xml")
